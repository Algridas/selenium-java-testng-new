...
public class Topic_06_Paramenter_Environment {
	WebDriver driver;
	...
	@Parameters("browser") // để parameter ntn thì mình phải define ở trong file xml, nếu ko có @optional thì phải define trong file xml
	@BeforeClass
